...
export default function AdminForm({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      can_promote: toBoolean(selectedAdmin?.can_promote),
      can_demote: toBoolean(selectedAdmin?.can_demote),
    });
    setError("");
  }, [open, selectedAdmin]);
  ...
  const handleSubmit = async () => {
    if (
      ["username", "first_name", "last_name", "email"].some(
    ...
    >
      ...
      <DialogActions>
        ...
        <Button onClick={handleSubmit} variant="contained" disabled={loading}>
          {isEditMode ? "Update Access" : "Create Account"}
        </Button>
      </DialogActions>
    </Dialog>
  );
